...
(function() {
    ...
    var options = {
        ...
        colorPalette: [
            { content: 'transparent', icon: './Rappid Demo Application_files/assets/transparent-icon.svg' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        colorPaletteReset: [
            { content: undefined, icon: './Rappid Demo Application_files/assets/no-color-icon.svg' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        imageIcons: [
            { value: './Rappid Demo Application_files/assets/image-icon1.svg', content: '<img height="42px" src="./Rappid Demo Application_files/assets/image-icon1.svg"/>' },
            { value: './Rappid Demo Application_files/assets/image-icon2.svg', content: '<img height="80px" src="./Rappid Demo Application_files/assets/image-icon2.svg"/>' },
            { value: './Rappid Demo Application_files/assets/image-icon3.svg', content: '<img height="80px" src="./Rappid Demo Application_files/assets/image-icon3.svg"/>' },
            { value: './Rappid Demo Application_files/assets/image-icon4.svg', content: '<img height="80px" src="./Rappid Demo Application_files/assets/image-icon4.svg"/>' }
        ],

        imageGender: [
            { value: './Rappid Demo Application_files/assets/member-male.png', content: '<img height="50px" src="./Rappid Demo Application_files/assets/member-male.png" style="margin: 5px 0 0 2px;"/>' },
            { value: './Rappid Demo Application_files/assets/member-female.png', content: '<img height="50px" src="./Rappid Demo Application_files/assets/member-female.png" style="margin: 5px 0 0 2px;"/>' }
        ],
