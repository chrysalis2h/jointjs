...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash'), require('jquery'), require('backbone')) :
    typeof define === 'function' && define.amd ? define(['exports', 'lodash', 'jquery', 'backbone'], factory) :
    (global = global || self, factory(global.joint = {}, global._, global.$, global.Backbone));
    ...
    */
    ...
    var normal = function normal(sourcePoint, targetPoint, route, opt) {
      var raw = opt && opt.raw;
    ...
    var normal$1 = function normal(vertices, opt, linkView) {
      return vertices;
    };
    ...
    var Paper = View.extend({
      ...
      options: {
        ...
        highlighterNamespace: highlighters$1,
        anchorNamespace: anchors$1,
        linkAnchorNamespace: linkAnchors,
        connectionPointNamespace: connectionPoints$1
      },
      events: {
      ...
      render: function render() {
        ...
        this.tools = V('g').addClass(addClassNamePrefix('tools-container')).node; // Append `<defs>` element to the SVG document. This is useful for filters and gradients.
    ...
    var Button = ToolView.extend({
      ...
      update: function update() {
        ...
        var matrix = V.createSVGMatrix().translate(position.x, position.y).rotate(angle).translate(0, this.options.offset || 0);
    ...
    exports.anchors = anchors$1;
    exports.linkAnchors = linkAnchors;
    exports.connectionPoints = connectionPoints$1;
    exports.connectionStrategies = index;
    exports.connectors = connectors$1;
    exports.dia = index$1;
    exports.highlighters = highlighters$1;
    exports.mvc = index$4;
    exports.routers = routers$1;
    exports.util = index$3;
    exports.linkTools = index$2;
